...
import com.vijay.blockchain.model.posts.req.registerUpload.RegisterUploadRequest
import com.vijay.blockchain.model.posts.req.registerUpload.ServiceRelationships
...
import com.vijay.blockchain.Constants
import com.vijay.blockchain.LinkedinPostResponseListner
import com.vijay.blockchain.model.posts.req.ugcPosts.*
        ...
        callRegisterUpload.enqueue(object : Callback<RegisterUploadResponse> {
            ...
            override fun onResponse(
                ...
                if (response.code() == 200) {
                    ...
                    val callUploadImg =
                        response.body()
                            ?.value?.uploadMechanism?.mediaUploadHttpRequest?.uploadUrl?.let {
                            val url = it
